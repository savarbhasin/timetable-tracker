...
const timetableData: TimetableData = {
  steps: [
    ...
    },
    {
      id: 5,
      title: "Strings",
      dates: "7th February – 10th February",
      tasks: [
        { id: "5-1", date: "7th Feb (Fri)", description: "Complete", count: 5 },
        { id: "5-2", date: "8th Feb (Sat)", description: "Complete", count: 5 },
        { id: "5-3", date: "9th Feb (Sun)", description: "Complete", count: 5 },
      ],
    },
    {
      id: 6,
